!(function () {
  function o(t, i) {
    (this.title = t.title),
      ...
      (this.icon.innerHTML = (function (t) {
        var i;
        i = t.match(/[&;=<>"']/)
          ? t
          : ((t = t.replace(/(^\s*|\s*$)/g, "")),
            ...
            0 === t.indexOf("fa-")
              ? L.DomUtil.addClass(i, "fa " + t)
              : 0 === t.indexOf("glyphicon-")
              ? L.DomUtil.addClass(i, "glyphicon " + t)
              : L.DomUtil.addClass(i, t),
            i.outerHTML);
        return i;
      })(t.icon)),
      (this.onClick = L.Util.bind(t.onClick ? t.onClick : function () {}, i));
  }
  (L.Control.EasyBar = L.Control.extend({
    ...
    initialize: function (t, i) {
      ...
      for (var e = 0; e < t.length; e++)
        (t[e]._bar = this),
          ...
          this.container.appendChild(t[e].button);
    },
    ...
    addTo: function (t) {
      ...
      return (
        L.DomUtil.addClass(e, "leaflet-control"),
        -1 !== s.indexOf("bottom") ? n.insertBefore(e, n.firstChild) : n.appendChild(e),
        this
      );
    },
  })),
    ...
    (L.Control.EasyButton = L.Control.extend({
      ...
      initialize: function (t, i, e, s) {
        (this.options.states = []),
          null != s && (this.options.id = s),
          (this.storage = {}),
          "object" == typeof arguments[arguments.length - 1] &&
            L.Util.setOptions(this, arguments[arguments.length - 1]),
          0 === this.options.states.length &&
            "string" == typeof t &&
            "function" == typeof i &&
            this.options.states.push({ icon: t, onClick: i, title: "string" == typeof e ? e : "" }),
          (this._states = []);
        for (var n = 0; n < this.options.states.length; n++)
          this._states.push(new o(this.options.states[n], this));
        this._buildButton(), this._activateState(this._states[0]);
      },
      _buildButton: function () {
        if (
          ((this.button = L.DomUtil.create(this.options.tagName, "")),
          "button" === this.options.tagName && this.button.setAttribute("type", "button"),
      ...
      state: function (t) {
        return 0 === arguments.length
          ...
          : ("string" == typeof t
              ? this._activateStateNamed(t)
              : "number" == typeof t && this._activateState(this._states[t]),
            this);
      },
      ...
      _activateState: function (t) {
        if (t !== this._currentState) {
          "replace" == this.options.type &&
            (this.button.appendChild(t.icon), this.button.removeChild(this._currentState.icon)),
            t.title ? (this.button.title = t.title) : this.button.removeAttribute("title");
          for (var i = 0; i < this._states.length; i++)
            L.DomUtil.removeClass(this._states[i].icon, this._currentState.stateName + "-active"),
              L.DomUtil.addClass(this._states[i].icon, t.stateName + "-active");
      ...
      onAdd: function (t) {
        var i = L.easyBar([this], {
          position: this.options.position,
          leafletClasses: this.options.leafletClasses,
        });
        return (
          (this._anonymousBar = i), (this._container = i.container), this._anonymousBar.container
        );
      },
      removeFrom: function (t) {
        return this._map === t && this.remove(), this;
      },
    })),
